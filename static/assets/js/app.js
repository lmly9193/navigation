    ...
    e.fn.perfectScrollbar = function (n, i) {
        return this.each(function () {
            ...
            function u() {
                ...
                Z
                    ? (t.right = B ? C - M.scrollLeft() - V - J.outerWidth() : V - M.scrollLeft())
                    : (t.left = B ? M.scrollLeft() + 2 * E - C - $ - J.outerWidth() : $ + M.scrollLeft()),
                    G.css(t),
            ...
            function b() {
                function e(e) {
                    ...
                    return (
                        (t === void 0 || o === void 0) &&
                            ((t = (-1 * e.originalEvent.wheelDeltaX) / 6), (o = e.originalEvent.wheelDeltaY / 6)),
                    ...
                    e(window).bind(K('mousemove'), function (e) {
                        if (i) {
                            ...
                            t.x < a.left + 3
                                ...
                                : (l.left = 0),
                                t.y < a.top + 3
                                    ? ((l.top = 5 > a.top + 3 - t.y ? -5 : -20), G.addClass('in-scrolling'))
                                    : t.y > a.bottom - 3
                                    ? ((l.top = 5 > t.y - a.bottom + 3 ? 5 : 20), G.addClass('in-scrolling'))
                                    : (l.top = 0),
